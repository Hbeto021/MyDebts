package com.htolintino.mydebts.manageDebt.view.activity
...
import com.htolintino.mydebts.manageDebt.view.fragment.AddDebtFragment
import com.htolintino.mydebts.manageDebt.view.fragment.EditDebtFragment
...
class ManageDebtActivity : AppCompatActivity() {
    ...
    private fun loadView() {
        ...
        } ?: inflateFragment(AddDebtFragment())
